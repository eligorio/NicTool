...
CREATE TABLE nt_zone_record(
    ...
    matchingtype        SMALLINT(2) NULL DEFAULT NULL ,
    cert                TEXT NULL DEFAULT NULL ,
    keytag              INT NULL DEFAULT NULL ,
    digtype             SMALLINT(2) NULL DEFAULT NULL ,
    digest              VARCHAR(8192) NULL DEFAULT NULL ,
    algorithm           SMALLINT(2) NULL DEFAULT NULL ,
